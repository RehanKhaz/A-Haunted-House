...
while (condition) {
    ...
    let rooms = [
        chalk.greenBright("You came into the room of CHURAIL and he imprisons you."),
        chalk.greenBright("Unfortunately, you come to the room of Lion and become his meal."),
    ...
    if (random === rooms[0] || random === rooms[1]) {
        ...
        console.log(random);
        console.log(chalk.blueBright `Congratulations! You find the key of the door. Now you've to free your best friend. Go and Find your best Friend.`);
        ...
        let rooms = [
            "You came into the room of the Devil and now he also imprisons you.",
        ...
        if (randomRoom === rooms[0] || randomRoom === rooms[1]) {
            ...
            console.log("Congratulations on finding your best friend!. You are truly a courageful person. You makes every single effort to rescue your friend. All the friends showed be like you.");
            console.log(chalk.bgWhite.blueBright `Now you & your friends are free to go home.`);
        ...
        let rooms = [
            "You went into the room of the CHURAIL and now he imprison you as well as your best Friend.",
            "Unfortunately , you and your best friend goes to the room of Lion become his meal.",
        ...
        if (randomRoom2 === rooms[0] || randomRoom2 === rooms[1]) {
            ...
            console.log(chalk.rgb(255, 165, 0) `Congratulations on finding the key. You are truly a courageful person. You makes every single effort to rescue your friend. All the friends showed be like you."`);
            console.log(chalk.white.bgGreen `Now you & your friend are free to go to home.`);
